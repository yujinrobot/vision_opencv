...
if(NOT "include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
