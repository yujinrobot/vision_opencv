...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry)
  set(image_geometry_DEVEL_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /usr/local)
...
if(NOT "/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry/include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry/include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/opt/yujin/amd64/kinetic-devel/lib/libopencv_calib3d.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_core.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_dnn.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_features2d.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_flann.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_highgui.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_imgcodecs.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_imgproc.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_ml.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_objdetect.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_photo.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_shape.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_stitching.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_superres.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_video.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_videoio.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_videostab.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_viz.so.3.3.1")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/image_geometry/devel/lib;/opt/groot/navi_ws/devel/lib;/opt/groot/messages_ws/devel/lib;/opt/yujin/amd64/kinetic-devel/lib;/opt/ros/kinetic/lib)
