...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge/devel)
...
if(NOT "/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge/include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge/include;/opt/yujin/amd64/kinetic-devel/include;/opt/yujin/amd64/kinetic-devel/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/opt/yujin/amd64/kinetic-devel/lib/libopencv_core.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_imgproc.so.3.3.1;/opt/yujin/amd64/kinetic-devel/lib/libopencv_imgcodecs.so.3.3.1")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/cv_bridge/devel/lib;/opt/groot/navi_ws/devel/lib;/opt/groot/messages_ws/devel/lib;/opt/yujin/amd64/kinetic-devel/lib;/opt/ros/kinetic/lib)
