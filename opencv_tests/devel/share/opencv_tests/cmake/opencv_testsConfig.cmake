...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/opencv_tests/devel)
  ...
  set(opencv_tests_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/opencv_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/groot/new_libs/vision_opencv/vision_opencv-kinetic/opencv_tests/devel/lib;/opt/groot/navi_ws/devel/lib;/opt/groot/messages_ws/devel/lib;/opt/yujin/amd64/kinetic-devel/lib;/opt/ros/kinetic/lib)
